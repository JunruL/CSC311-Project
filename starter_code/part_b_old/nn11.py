...
class AutoEncoder(nn.Module):
    def __init__(self, num_student):
        ...
        self.g1 = nn.Linear(num_student, 128)
        self.g2 = nn.Linear(128, 32)

        self.s1 = nn.Linear(num_student, 128)
        self.s2 = nn.Linear(128, 32)

        self.t1 = nn.Linear(num_student, 128)
        self.t2 = nn.Linear(128, 32)

        self.h2 = nn.Linear(32+32+32, 192)
        self.h1 = nn.Linear(192, num_student)
